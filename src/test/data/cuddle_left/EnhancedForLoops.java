...
public class SomeClass {
    ...
    private void doUncuddledNested( List<String> list ) {
        for( String str : list )
        {
    ...
    private void doSingleLineWithComment( List<String> list ) {
        for( String str : list ){System.out.println( "one" );}// comment 1
    }
